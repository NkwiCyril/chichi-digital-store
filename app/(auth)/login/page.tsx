          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <svg className="w-4 h-4" viewBox="0 0 533.5 544.3">
                <path
                  fill="#4285f4"
                  d="M533.5 278.4c0-17.4-1.5-34-4.3-50.2H272.1v95h146.9c-6.3 34.1-25.3 62.9-54.1 82.2l87.3 67.7c50.9-46.9 81.3-116 81.3-194.7z"
                />
                <path
                  fill="#34a853"
                  d="M272.1 544.3c73.5 0 135.2-24.3 180.2-66.1l-87.3-67.7c-24.3 16.3-55.4 25.8-92.9 25.8-71.5 0-132.1-48.2-153.8-113.1l-90.6 70.1c41.5 82.6 127 151 244.4 151z"
                />
                <path
                  fill="#fbbc04"
                  d="M118.3 323.2c-10.8-32.2-10.8-66.9 0-99.1l-90.6-70.1c-39.7 79.2-39.7 170.1 0 249.3z"
                />
                <path
                  fill="#ea4335"
                  d="M272.1 107.7c39.9-.6 77.3 13.6 106.4 39.8l79.3-79.3C405.6 24.7 344-0.5 272.1 0 154.7 0 69.2 68.4 27.7 151l90.6 70.1c21.8-64.9 82.4-113.4 153.8-113.4z"
                />
              </svg>
              {isPending ? "Please wait..." : "Sign in with Google"}
            </button>
          </form>

          <p className="text-center text-sm text-zinc-500">
            Don&apos;t have an account?{" "}
            <Link href={{ pathname: "/register", query: { next: nextPath } }} className="text-violet-600 font-semibold hover:text-violet-700">
              Create one
            </Link>
          </p>
        </div>
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-12 text-white">
          <div>
            ...
            <h2 className="mt-6 text-3xl font-semibold leading-tight">
              Built for creators who want beautiful storefronts without engineering overhead.
            </h2>
          </div>
